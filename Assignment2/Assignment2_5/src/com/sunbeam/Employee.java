...
public class Employee {
	...
	public static void main(String[] args) {
		...
		arr[0]=new Employee(1,"Anjali",50000);
		arr[1]=new Employee(2,"Shamal",30000);
		arr[2]=new Employee(3,"Ami",40000);
		System.out.println("Employees array before sorting by salary : "+Arrays.toString(arr));
		
		FurtherImprovedBubbleSort(arr,arr.length);
        System.out.println("Employees Array after sorting : "+Arrays.toString(arr));
	}
